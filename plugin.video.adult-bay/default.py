...
def GetTitles(section, url, startPage= '1', numOfPages= '1'): # Get Movie Titles
        print 'adult-bay get Movie Titles Menu %s' % url
        ...
        for page in range( start, end):
        		...
        		cm.append(('Search on adult-bay', runstring))
...
def GetSearchQuery():
	...
	keyboard = xbmc.Keyboard()
        keyboard.setHeading('Search Adult Bay')
...
def Search(query):
        url = 'http://www.google.com/search?q=site:adultbay.org ' + query
        url = url.replace(' ', '+')
        print url
